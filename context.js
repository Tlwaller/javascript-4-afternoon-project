...
/*
Below we have the class Animal.  The eat method is using the "this" keyword.  Use the "new" keyword to assign context to "this", and save the instance to a 
...
//Code Here
var animal1 = new Animal('howard', 'cat', 'rocks');
